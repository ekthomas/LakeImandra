      ...
      do j=1,inum
        ...
        read(20,*) v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v13, v14, v15, v16, v17, v18, v19  ! match number of parameters in lake-params.txt
...
! CHANGE following lines to specify ranges for lake.inc parameters you wish to vary
      ...
      v3 = 0.2*v3 + 0.7       ! alb_snow from 0.7 to 0.9
      v4 = 0.3*v4 + 0.4       ! alb_slush from 0.4 to 0.7
...
!      v19 = 50 * v19            ! glacier_flux from 0 to 50??       
...
!      write(24,"(a,f16.8)") "glacier_flux = ", v19
      close(24)
